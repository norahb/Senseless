...
# model = create_model('efficientnet_lite0')
# PATH_model="student_half.pt"
...
path = '../eval_tool/jhu_crowd_v2.0/jhu_crowd_v2.0/test'
...
for file_id,count,scene,weather,dis in zip(pd_target[0],pd_target[1],pd_target[2],pd_target[3],pd_target[4]):
    ...
    kk=14 #12 is the best for lite0 rightnow
...
print(PATH_model,"total_parameter:", sum(p.numel() for p in model.parameters()))
