...
class ConfigManager:
    ...
    configs = {
        "appliance": UseCaseConfig(
            name="appliance",
            sensor_data_path=base_path / "sensor_data" / "appliance" / "Appliance_training_split.csv", 
            image_data_path=base_path / "sensor_data" / "appliance" / "Appliance_images.csv",
            ...
            inference_csv_path=base_path / "sensor_data" / "appliance" / "Appliance_images.csv",
        ...
        "co2": UseCaseConfig(
            name="co2",
            sensor_data_path=base_path / "sensor_data" / "co2" / "CO2_training_split.csv",
            image_data_path=base_path / "sensor_data" / "co2" / "CO2_images.csv",
            ...
            inference_csv_path=base_path / "sensor_data" / "co2" / "CO2_images.csv",
        ...
        "door": UseCaseConfig(
            ...
            inference_csv_path=base_path / "sensor_data" / "door" / "Door_images.csv",
        ...
        "abnormal_object": UseCaseConfig(
            ...
            sensor_data_path=base_path / "sensor_data" / "abnormal_object" / "Abnormalobj_training_split.csv",
            image_data_path=base_path / "sensor_data" / "abnormal_object" / "Abnormalobj_images.csv",
            ...
            inference_csv_path=base_path / "sensor_data" / "abnormal_object" / "Abnormalobj_images.csv",
